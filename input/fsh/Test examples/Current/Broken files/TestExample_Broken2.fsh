//OBS: Change dates to invalid dates before handing out the example. This is what makes it broken.
Instance: a8361308-e6cf-4531-b079-01d2760063c8
InstanceOf: MedComConditionListBundle
Usage: #example
Title: "Bundle instance - TestExample Broken2"
Description: "Bundle instance - TestExample Broken2"
* type = #document
