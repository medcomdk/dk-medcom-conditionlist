...
* type from $PcaTypeCode (required) 
...
* content.format from $PcaFormatCode (required)
* content.attachment.contentType from $PcaContentType
...
* extension.valueCoding from $PcaHomeCommunityID (required)
...
* type = $LoincOID#HL7v3-PCA "Problem Concern Act"
...
* content.format = $MedComFormatOID#urn:ad:dk:medcom:pca-v1.0:full "DK PCA schema"
